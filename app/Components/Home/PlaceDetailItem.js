...
export default function PlaceDetailItem({ place, onDirectionClick }) {
  return (
    <View>
      <Text style={{ fontSize: 20, fontWeight: "600" }}>{place.name}</Text>
      <View
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <Text>{place?.rating ? place.rating : "No Reviews Yet"}</Text>
      </View>
      {/* {place?.photos ? (
        <Image
          source={{
      ...
      >
        ...
        >
          ...
          <Text style={{ fontWeight: "600", fontSize: 16 }}>Direction</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text style={{ fontWeight: "600", fontSize: 16 }}>Share</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
